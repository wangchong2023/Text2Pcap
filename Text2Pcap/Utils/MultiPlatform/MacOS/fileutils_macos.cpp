...
QString FileUtilsMacOS::GetSubAppPathByRootAndSubName(QString rootDir, QString subAppName) {
...
QString FileUtilsMacOS::GetSubAppPathByAppAndSubName(QString appPath, QString subAppName) {
