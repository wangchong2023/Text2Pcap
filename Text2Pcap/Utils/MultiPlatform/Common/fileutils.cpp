...
QString FileUtils::GetSubAppPathByRootAndSubName(QString rootDir,
                                                 QString subAppName) {
#ifdef Q_OS_MACOS
...
QString FileUtils::GetSubAppPathByAppAndSubName(QString appPath,
                                                QString subAppName) {
#ifdef Q_OS_MACOS
...
bool FileUtils::isDirExist(QString dirPath) { return isFileExist(dirPath); }
