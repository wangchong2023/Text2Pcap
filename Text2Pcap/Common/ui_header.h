...
#define UI_RES_STRING_DEFAULT_SYSTRAY_MSG tr("尽情使用报文解析工具带给你的便捷吧！")
#define UI_RES_STRING_DEFAULT_EMAIL_HREF "<a href=\"mailto:wangchong@msn.com\">wangchong@msn.com"
...
/* 控件 */
#define UI_RES_CONTROL_TEXT2WIDGET_WS_DIAG_TITLE   tr("指定wireshark可执行文件路径")
